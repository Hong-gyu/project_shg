...
public class Polymorphis {
	...
	public static void repair (Tire tire) {
		/* (HankookTire)tire.company : Tire 인터페이스의 멤버변수 company를 찾은 후 tire를 HankookTire 로 타입 변환 */
		/* ((KumhoTire)tire).company : tire를 한국타이어로 타입 변환 후 멤버변수 company를 찾음 */
...
class KumhoTire implements Tire {
	String company = "금호";
	public void roll() {
		System.out.println("금호타이어가 글러갑니다.");
	}
}
...
class HankookTire implements Tire {
	String company = "한국";
	public void roll() {
		System.out.println("한국타이어가 글러갑니다.");
	}	
}