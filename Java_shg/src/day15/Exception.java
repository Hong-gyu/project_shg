...
public class Exception {
	...
	public static void main(String[] args) {
		...
		/* 실행예외의 종류
		 *  1. NullPointerException : 참조변수를 이용하는 경우 발생. 참조변수는 null로 초기화가 가능하기 때문에
		 ...
		 *  3. NumberFormatException : 문자열을 숫자로 변환할 때에 발생할 수 있다. 문자열에 숫자가 아닌 문자들이 있는 경우 발생
		 *  	- 해결방법 : 따로 없음 -> 예외가 발생한 후 처리해야함
		 *  4. ClassCastException : 클래스 타입 변환시 발생할 수 있다.
