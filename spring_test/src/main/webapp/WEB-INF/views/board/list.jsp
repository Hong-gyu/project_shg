	...
	<div class="container">
	  ...
	  <form method = "get" action="<%=request.getContextPath()%>/board/list">
		<div class="input-group mb-3">
			...
			<button class = "form-control btn btn-outline-dark">검색</button>
		</div>	  
	  </form>
	  ...
	  <a href="<%=request.getContextPath()%>/board/register"><button class = "btn btn-outline-success"> 게시글 등록 </button></a>
	</div>
	<script type="text/javascript">
		$(function(){
			var msg = '${msg}';
			printMsg(msg);
			histroy.replaceState({},null,null);
		})
		
		function printMsg(msg){
			if(msg == '' || histroy.state){
				return;
			}
			alert(msg);
		}
